...
function col(content) {
  var styles = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  return "<div style=\"".concat(styles, "\" class=\"col-sm\">").concat(content, "</div>");
}
  ...
  _createClass(Sidebar, [{
    ...
    value: function add(event) {
      ...
      if (type === 'Заголовок') {
        ...
        var obj = eval("({styles:{ row: {height: '".concat(HGstyles, "', 'text-align': 'center', 'background-color': '#fff',  margin: '20px',}, col: {'background-color': '").concat(BGstyles, "',color: '").concat(CLstyles, "', margin: '5px', 'border-radius': '5px'}}})"));
...
new _app.App(_model.model).itit();
